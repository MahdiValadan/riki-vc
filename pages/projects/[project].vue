        ...
        <div
            ...
            <div class="flex flex-row items-center flex-wrap gap-x-[8%] gap-10 w-full rounded-md">
                ...
                <div class="flex flex-col items-center w-full sm:w-8/12 lg:w-5/12 m-auto lg:m-0 gap-3">
                    ...
                    <img class="border-4 border-[#0e7490] rounded p-3" :src="'/images/projects/' + project.image + '.jpg'"
                        alt="project image">
                    <LinkButton class="mt-4" :link="project.link" buttonText="Visit site"></LinkButton>
                </div>
                ...
                <div class="flex flex-col gap-7 w-full lg:w-6/12 text-black text-base sm:text-lg">
                    ...
                    <div class="mt-5">
                        ...
                        <NuxtLink :to="'/persons/' + project.person.id" class="text-[#0e7490] text-lg font-bold ">
                            {{ project.person.name }}
                        </NuxtLink>
                    </div>
            ...
            <div id="project-detail-info" class="flex flex-col gap-5 items-center w-full">
                <!-- CONTENT -->
                <h2 id="project info title" class="text-2xl font-bold w-full">
                    The impact of {{ project.name }}
                </h2>
                <div id="detail text" class="whitespace-pre-line mb-14 text-base w-full">
                    {{ project.desc_content }}
                </div>
                <!-- DATA -->
                <div id="number data" class="w-full flex flex-col items-center justify-between gap-y-20 gap-x-28
                lg:flex-row lg:justify-center pt-5 pb-20">
                    <!-- 1 -->
                    <div id="1-data" class="flex flex-col items-center text-center">
                        <div id="number1" class="text-[#0e7490] text-4xl sm:text-6xl">
                            {{ project.desc_data[0] }}
                        </div>
                        <div id="data1" class="">
                            {{ project.desc_data[1] }}
                    ...
                    <!-- 2 -->
                    <div id="2-data" class="flex flex-col items-center text-center">
                        <div id="number2" class="text-[#0e7490] text-4xl sm:text-6xl">
                            {{ project.desc_data[2] }}
                        </div>
                        <div id="data2" class="">
                            {{ project.desc_data[3] }}
                    ...
                    <!-- 3 -->
                    <div id="3-data" class="flex flex-col items-center text-center">
                        <div id="number3" class="text-[#0e7490] text-4xl sm:text-6xl">
                            {{ project.desc_data[4] }}
                        </div>
                        <div id="data3" class="">
                            {{ project.desc_data[5] }}
